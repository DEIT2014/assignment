...
void handleGet(HttpRequest req) {
  ...
  if (file.existsSync()) {
    ...
    file.readAsBytes().asStream().pipe(res);
    print("finished");// automatically close output stream
 }
...
void defaultHandler(HttpRequest req) {
  ...
  res.writeln("Not found: ${req.method}, ${req.uri.path}");
  res.close();
}
*/
